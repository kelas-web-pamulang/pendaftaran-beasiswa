        ...
        <div class="registration-card">
            ...
            <form action="" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" id="kurangiKuota" name="stok_kurang" placeholder="Masukkan jumlah stok pengurangan" value="0">
                </div>
                <div class="form-group mb-3">
                    <label for="tambahKuota">Tambah Kuota</label>
                    <input type="number" class="form-control" id="tambahKuota" name="stok_tambah" placeholder="Masukkan jumlah stok pengurangan" value="0">
                </div>
